# Social media web application project where you can find or share interesting places in your local area. Users can add posts that are their opinions about a place. Posts can be sorted by region.
